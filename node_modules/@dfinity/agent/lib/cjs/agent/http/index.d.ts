...
import { HttpAgentRequest, HttpAgentRequestTransformFn, HttpAgentSubmitRequest } from './types';
...
export declare class HttpAgent implements Agent {
    ...
    prepareCallRequest(canisterId: Principal | string, options: {
        methodName: string;
        arg: ArrayBuffer;
        effectiveCanisterId?: Principal | string;
    }, sender: Principal): Promise<HttpAgentSubmitRequest>;
    submitRequest(req: HttpAgentSubmitRequest): Promise<{
        requestId: RequestId;
        response: {
            ok: boolean;
            status: number;
